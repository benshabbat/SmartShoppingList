...
import { useMainShoppingViewLogic } from './MainShoppingView/useMainShoppingViewLogic'
import { 
  GuestSection,
  AddItemSection,
  SuggestionsSection,
