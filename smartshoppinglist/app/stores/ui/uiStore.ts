  ...
  devtools(
    persist(
      immer((set, get) => ({
        ...
        openModal: (modal) =>
          set((state) => {
            state.activeModal = { ...modal, id: Date.now().toString() }
          }),
        ...
        // Missing functions - add dummy implementations
        closeModalById: () => {},
        toggleNotifications: () => {},
        ...
        toggleTutorial: () => {},
        setTutorialEnabled: () => {},
        updateQuickAddSuggestions: () => {},
        addQuickAddSuggestion: () => {},
        removeQuickAddSuggestion: () => {},
        clearQuickAddSuggestions: () => {},
        updateItemSuggestion: () => {},
        removeItemSuggestion: () => {},
        clearItemSuggestions: () => {},
        addBulkSuggestions: () => {},
        toggleReceiptScanner: () => {},
        openDataExport: () => {},
        closeDataExport: () => {},
        openDataImport: () => {},
        closeDataImport: () => {},
        toggleEnhancedStatistics: () => {},
        setStatisticsView: () => {},
        ...
        setSelectedCategory: () => {},
        toggleCartItemsOnly: () => {},
        setShowOnlyCartItems: () => {},
        togglePurchasedItemsVisibility: () => {},
        setShowPurchasedItems: () => {},
        toggleClearCompletedItems: () => {},
        setClearCompletedItems: () => {},
        toggleAutoArchive: () => {},
        setAutoArchive: () => {},
        toggleCompletedItems: () => {},
        setShowCompletedItems: () => {},
        showGuestNotification: () => {},
        hideGuestNotification: () => {},
        setGuestNotificationVisible: () => {},
        updateGuestSettings: () => {},
        resetGuestSettings: () => {},
        resetCompletedTutorialSteps: () => {},
        clearCheckout: () => {},
        resetUIState: () => {},
      })),
      {
